                        ...
                        case 1:
                            {
                                ...
                                if (element.childNodes.length === 0 && (nodeName === "th" || nodeName === "td")) ret.push({
                                    text: ""
                                });
                                else {
                                    ...
                                    case "img":
                                        {
                                            ...
                                            ret = {
                                                text: 'Trykk for å åpne bilde',
                                                link: 'https://prosjekthjelper.no/'+imgUrl,
                                                alignment: 'center',
                                                background:'#f2f2f2',
                                                margin: [0, 5, 0, 10],
                                                padding: [5, 5, 5, 5]
                                ...
                                if (ret) {
                                    if (Array.isArray(ret)) {
                                        if (ret.length === 1 && nodeName !== "tr") {
                                            ...
                                            ret = !isInlineTag || /{"(stack|table|ol|ul|image)"/.test(JSON.stringify(ret)) ? {
                                                stack: ret
                                            } : {
                                                text: ret
                                            };
